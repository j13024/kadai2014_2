...
public class Bomb extends BulletBase {
    ...
    * 発射から着弾までの時間
    */
    static final int EXPLOSION_FRAME = 1;
    ...
    */
    ...
    public Bomb(GameSceneBase scene, FighterBase shooter) {
        ...
        // 画面の中心に着弾させる
        final Vector2 IMPACT_PO = new Vector2(Define.VIRTUAL_DISPLAY_WIDTH / 2, Define.VIRTUAL_DISPLAY_HEIGHT / 2);
        final Vector2 IMPACT_POS = new Vector2(-100, -100);
